...
export const metadata: Metadata = {
  title: "Privacy Policy - RefereBook",
  description:
    "Learn how RefereBook collects, uses, and protects your personal information.",
};
          ...
          <div className='prose prose-lg max-w-none'>
            <section className='mb-8'>
              ...
              <p className='text-gray-700 mb-4'>
                RefereBook ("we," "our," or "us") is committed to protecting
            ...
            <section className='mb-8'>
              ...
              <ul className='list-disc pl-6 mb-4 text-gray-700 space-y-2'>
                ...
                <li>
                  Process your transactions and send purchase confirmations
                </li>
                <li>Track and manage referral rewards</li>
                <li>
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700 mb-4'>
                ...
                differ. We will take all steps reasonably necessary to ensure
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-700'>
                ...
                <br />
                Address: 123 Book Street, Library District, San Francisco, CA
                94102, United States
              </p>
            </section>
          </div>
